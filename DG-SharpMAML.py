...
class input_data():
    def __init__(self):
        ...
        self.output_folder = ''
        self.num_ways = 5 # 20 for Omniglot
        self.num_shots = 1 # 5 is a feasible value for both datasets
        self.num_shots_test = 15
        self.hidden_size = 64
        self.batch_size = 4
        self.num_steps = 5
        self.num_epochs = 2 # 600
        self.num_batches = 2 # 100
        self.step_size = 0.001 # 0.1 #0.0001
